class Renderer
{
    ...
    initRenderer()
    {
        ...
        this.glContext.clearColor(0.05, 0.05, 0.08, 1.0);
    ...
    drawScene(programInfo, buffers) 
    {
        ...
        this.glContext.useProgram(programInfo.program);
    ...
    setPositionAttribute(buffers, programInfo) 
    {
        ...
        this.glContext.bindBuffer(this.glContext.ARRAY_BUFFER, buffers.position);
        ...
        this.glContext.enableVertexAttribArray(programInfo.attribLocations.vertexPosition);
    }
}
